# Iron Track Railway Defect Detection Dataset 4000 Samples Supports Yolo Format

# Body

Iron Track Railway Defect Detection Dataset, 4000 images, Yolo format
or change
This is suitable for iron track railway defect detection, target detection model training, research.

Category: Wear, abrasion, sinking, wheel burn
